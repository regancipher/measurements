...
const init_phones = ["Harman 2019 IE v2 Target.txt"],            // Optional. Which graphs to display on initial load. Note: Share URLs will override this set
      ...
      page_title = "Frequency Responses - Squiglink by ReganCipher",
...
{ type:"Preference", files:["Harman 2019 IE v2", "Harman 2018 OE", "Rtings","Sonarworks"] },
...
function watermark(svg) {
    ...
    wmSq.append("image")
        .attrs({x:481, y:152, width:150, height:141, "class":"wm-squiglink-logo", "xlink:href":"squiglink-giggle.svg"});
